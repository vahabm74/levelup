<section class="teacher ajax-box" id="course-instractors">
	<?php
		$section_title = ot_get_option('course_teacher_title');
	?>
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h3 class="title-section"><?php echo ($section_title) ? $section_title : 'Instractors Information';?></h3>
            </div>
        </div>
    </div>
    <div class="top-image" style="background-image:url('<?php echo ot_get_option("course_teacher_background");?>');"></div>
    <div class="details">
                    <div class="container">
                        <div class="row">
                            <?php
