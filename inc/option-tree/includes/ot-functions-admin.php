          ...
          array(
            ...
            'pages'               => array( 
              array(
                ...
                'page_title'      => apply_filters( 'ot_theme_options_page_title', __( 'Theme Settings','option-tree' ) ),
                'menu_title'      => apply_filters( 'ot_theme_options_menu_title', __( 'Theme Settings', 'option-tree' ) ),
                ...
                'position'        => apply_filters( 'ot_theme_options_position', __( '27', 'option-tree' ) ),
                'updated_message' => apply_filters( 'ot_theme_options_updated_message', __( 'Theme settings updated', 'option-tree' ) ),
                'reset_message'   => apply_filters( 'ot_theme_options_reset_message', __( 'Theme setting restored', 'option-tree' ) ),
  ...
  function ot_register_settings_page() {
    ...
    $ot_register_pages_array =  array( 
      ...
      array(
        ...
        'icon_url'        => null,
        'position'        => null,
        'updated_message' => __( 'Theme settings updated', 'option-tree' ),
        'reset_message'   => __( 'Theme settings restored', 'option-tree' ),
...
if ( ! function_exists( 'ot_admin_scripts' ) ) {
  ...
  function ot_admin_scripts() {
    ...
    $localized_array = array( 
      ...
      'reset_agree'           => __( 'Are you sure you want to reset the settings to default?', 'option-tree' ),
      'remove_no'             => __( 'You can\'t remove this! But you can edit the values.', 'option-tree' ),
      'remove_agree'          => __( 'Are you sure you want to delete this item?', 'option-tree' ),
  ...
  function ot_sections_view( $name, $key, $section = array() ) {
    ...
    <div class="option-tree-setting is-section">
      ...
      <div class="button-section">
        ...
        <a href="javascript:void(0);" class="option-tree-setting-remove option-tree-ui-button button button-secondary light right-item" title="' . __( 'Remove', 'option-tree' ) . '">
          <span class="icon ot-icon-trash-o"></span>' . __( 'Remove', 'option-tree' ) . '
        </a>
      </div>
