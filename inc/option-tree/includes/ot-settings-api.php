...
echo '<li>
<a href="https://levelupdans.com" rel="nofollow" target="_blank"><img style="height:auto;width:100%;" src="'.get_template_directory_uri().'/inc/option-tree/assets/images/header-theme-option.png"></a>
</li>';
            ...
            if ( $show_buttons ) {
              ...
              if ( $show_buttons ) {
                ...
                echo '<form method="post" action="' . str_replace( '&settings-updated=true', '', $_SERVER["REQUEST_URI"] ) . '">';
                  ...
                  echo '<button type="submit" class="option-tree-ui-button button button-secondary left reset-settings" title="' . __( 'Recover settings','option-tree' ) . '">' . __( 'Recover settings','option-tree' ) . '</button>';
