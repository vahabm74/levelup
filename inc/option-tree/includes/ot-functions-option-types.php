  ...
  function ot_type_list_item( $args = array() ) {
    ...
    echo '<div class="format-setting type-list-item ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* button */
        echo '<a href="javascript:void(0);" class="option-tree-list-item-add option-tree-ui-button button button-primary right hug-right" title="' . __( 'Add', 'option-tree' ) . '">' . __( 'Add', 'option-tree' ) . '</a>';
        
        /* description */
        $list_desc = $sortable ? __( 'You can move items by dragging and dropping.','on-tree' ) : '';
  ...
  function ot_type_post_select( $args = array() ) {
    ...
    echo '<div class="format-setting type-post-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* query posts array */
        $my_posts = get_posts( apply_filters( 'ot_type_post_select_query', array( 'post_type' => array( 'courses'), 'posts_per_page' => -1, 'orderby' => 'title', 'order' => 'ASC', 'post_status' => 'any' ), $field_id ) );
  ...
  function ot_type_slider( $args = array() ) {
    ...
    echo '<div class="format-setting type-slider ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* description */
        echo '<div class="list-item-description">' . __( 'You can move items by dragging and dropping.','on-tree' ) . '</div>';
  ...
  function ot_type_social_links( $args = array() ) {
    ...
    echo '<div class="format-setting type-social-list-item ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* button */
        echo '<a href="javascript:void(0);" class="option-tree-social-links-add option-tree-ui-button button button-primary right hug-right" title="' . __( 'Add', 'option-tree' ) . '">' . __( 'Add', 'option-tree' ) . '</a>';
        
        /* description */
        echo '<div class="list-item-description">' . apply_filters( 'ot_social_links_description', __( 'You can move items by dragging and dropping.','on-tree' ), $field_id ) . '</div>';
